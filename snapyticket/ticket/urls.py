...
from .views import TicketDetail, TicketView, _add_to_cart, _remove_from_cart, UpdateTicketItem, ticket_bag_summary
...
urlpatterns = [
    ...
    path('ticket/bag/summary/', ticket_bag_summary, name='ticket_bag_summary')
]
